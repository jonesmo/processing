...
public abstract class GEditableTextControl extends GTextBase implements Focusable {
	 ...
	 */
	public GEditableTextControl(PApplet theApplet, float p0, float p1, float p2, float p3) {
	...
	/**
	 * Cancels any selection. So the selection box will disappear. <br>
	 * WARNING: calling this function while the text control is accepting 
	 * keyboard will crash the sketch. <br>
