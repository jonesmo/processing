 ...
 * 
 * This class provides the ability to control the orientation the text should be
 * displayed. It also enables the use of labels for each tick mark.
 * 
 * @author Peter Lager
 *
 */
public abstract class GLinearTrackControl extends GValueControl {
	...
	/**
	 * Set the text orientation for the display of the limits and value if
	 * appropriate. <br>
	 ...
	 * must have at least 1 character. If these two conditions are not met then the
	 * call to this method will be ignored and no changes are made.
	 * 
	...
	/**
	 * Set whether the tick marks are to be displayed or not. Then recalculate the
	 * track offset for the value and limit text.
	 * 
	...
	/**
	 * The offset is the distance the value/labels are drawn from the centre of the
	 * track. <br>
