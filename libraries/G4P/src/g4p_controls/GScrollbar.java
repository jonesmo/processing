...
/**
 * This class is only used by the GDropList, GTextField and GTextArea components
 * to provide a scrollbar.
 * 
 * @author Peter Lager
 *
 */
class GScrollbar extends GAbstractControl {
	...
	public GScrollbar(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		makeBuffer();
		hotspots = new HotSpot[] { new HSrect(1, 0, 0, 16, height), // low cap
	...
	public void setToolTip(String text) {
		System.err.println("Tool tips are not available for the GScrollbar class");
	}
