...
/**
 * This slider is used to control 2 variables by dragging the thumb over a 2D
 * surface. It has all the features of the standard slider (GSlider) except that
 * it does not have ticks or stick-to-ticks functionality. <br>
 * 
 * If no limits are set then the control will return a value in the range 0.0 to
 * 1.0 for both the x and the y axis. The setXlimits and setYlimits can be used
 * to set a different range for each axis independently. <br>
 * 
 * The minimum size for this control is 40x40 pixels and this is enforced when
 * the control is created. If necessary the width and/or height the rectangle
 * will be increased to 40pixels. <br>
 * 
 * @author Peter Lager
 *
 */
public class GSlider2D extends GValueControl2D {
	...
	public GSlider2D(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		createEventHandler(G4P.sketchWindow, "handleSlider2DEvents", new Class<?>[] { GSlider2D.class, GEvent.class },
	...
	/**
	 * Set the amount of easing to be used when a value is changing. The default
	 * value is 1 (no easing) values &lt; 1 will cause the value to rush from its
	 * starting value and decelerate towards its final values. In other words it
	 * smoothes the movement of the slider thumb or knob rotation.
	 * 
	...
	/**
	 * X (horz) limits Sets the range of values to be returned. This method will
	...
	/**
	 * X (horz) limits Sets the initial value and the range of values to be
	 * returned. This method will assume that you want to set the valueType to
	 * INTEGER.
	 * 
	...
	/**
	 * Y (vert) limits Sets the range of values to be returned. This method will
	 * assume that you want to set the valueType to INTEGER
	 * 
	 * @param start the X start value of the range
	 * @param end   the X end value of the range
	...
	/**
	 * Y (vert) limits Sets the initial value and the range of values to be
	 * returned. This method will assume that you want to set the valueType to
	 * INTEGER.
	 * 
	 * @param initValue the initial value
	 ...
	 *         DECIMAL and EXPONENT value types will be rounded to the nearest
	 *         integer.
	 */
	...
	/**
	 * @return the current X value as a string taking into account the number
	 *         format. <br>
	 */
	...
	/**
	 * @return the current Y value as a string taking into account the number
	 *         format. <br>
	 */
