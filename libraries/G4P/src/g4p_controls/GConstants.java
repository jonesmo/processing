...
public interface GConstants {
	...
	// Also used to filter in GTextField 
	int INTEGER 		= 0;
	int DECIMAL 		= 1;
	int EXPONENT 		= 2;
	...
	// New one to reperesent undefined option
	...
	// Attribute:- underline   Value:- Boolean
	TextAttribute UNDERLINE 	= TextAttribute.UNDERLINE;
	// Predefined constants for font strike through on/off
	int UNDERLINE_ON 			= TextAttribute.UNDERLINE_ON; // 0 / true);
