...
/**
 * This class is used to trigger events at user defined intervals. The event
 * will call a user defined method/function. The only restriction is that the
 * method used has a single parameter of type GTimer and returns void eg <br>
 * 
 * <pre>
...
public class GTimer implements GConstantsInternal {
	 ...
	 * 'methodName'
	 * 
	 * For most users 'methodName' will be in their main sketch so this parameter
	 * has the same value as 'theApplet'
	 * 
	 * @param theApplet  a reference to the PApplet object (invariably <b>this</b>)
	 * @param obj        the object that has the method to be executed (likely to be
	 *                   <b>this</b>)
	 * @param methodName the name of the method to be called by the timer
	 * @param delay      the initial delay and the time (in millisecs) between
	 *                   function calls
	 */
	...
	/**
	 * See if 'obj' has a method called 'methodName' that has a single parameter of
	 * type GTimer and if so keep a reference to it.
	 * 
	 * @param obj
	 * @param methodName
	 */
	...
	/**
	 * Attempt to fire an event for this timer. This will call the method/function
	 * defined in the ctor.
	 */
	...
	/**
	 * Start the timer and call the method for the number of times indicated by
	 * nrepeats. If nrepeats is &le;0 then repeat forever
	 * 
	 ...
	 * 
	 * @return interval in millsecs or -1 if the timer failed to be created.
	 */
	 ...
	 * 
	 * @return initial delay in millsecs or -1 if the timer failed to be created.
	 */
