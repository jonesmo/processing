 ...
 * 
 * Although there maybe multiple requests for a particular bitmap file only one
 * PImage is created for each file.
 * 
 * @author Peter Lager
 *
 */
public class ImageManager {
	...
	public static PImage loadImage(PApplet app, String filename) {
		...
		if (image != null) {
			...
			System.out.println("Unable to load image from file '" + filename + "'");
		return image;
	}
	...
	/**
	 * Make multiple images from a given image. This method creates a 2D array (size
	 * [nCols, nRows] ) of PImage objects.
	 * 
	 * @param app   the main sketch applet
	...
	/**
	 * Make multiple images from a given image. This method creates a 1D array of
	 * PImage objects. The order is left-right and top-down.
	 * 
	 * @param app   the main sketch applet
	 * @param img   the tiled image
	 * @param nCols number of tiles across
