 ...
 * 
 * This class enables the creation of tick marks and constraining values to the
 * tick mark values. <br>
 * 
 * It also controls how the values are to be displayed INTEGER, DECIMAL or
 * EXPONENT
 * 
 * @author Peter Lager
 *
...
public abstract class GValueControl extends GAbstractControl {
	...
	/**
	 * This should be overridden in child classes so they can perform any class
	 * specific actions when the value changes. Override this in GSlider to change
	 * the hotshot position.
	 */
	...
	/**
	 * Sets the range of values to be returned. This method will assume that you
	 * want to set the valueType to INTEGER
	 * 
	...
	/**
	 * Sets the initial value and the range of values to be returned. This method
	...
	/**
	 * Sets the range of values to be returned. This method will assume that you
	 * want to set the valueType to DECIMAL
	 * 
	 * @param start the start value of the range
	 * @param end   the end value of the range
	 */
	...
	/**
	 * Sets the initial value and the range of values to be returned. This method
	 * will assume that you want to set the valueType to DECIMAL.
	 * 
	 * @param initValue the initial value
	 * @param start     the start value of the range
	 * @param end       the end value of the range
	...
	/**
	 * Make epsilon to match the value of 1 pixel or the precision which ever is the
	 * smaller
	 */
	...
	/**
	 * The units to be displayed with the current and limit values e.g. kg, m, ($),
	 * fps etc. <br>
	 * Do not use long labels such as 'miles per hour' as these take a lot of space
	 * and can look messy.
	 * 
	...
	/**
	 * If we are using labels then this will get the label text associated with the
	 * current value. <br>
	...
	/**
	 * Specify whether the values are to be constrained to the tick marks or not. It
	 * will automatically display tick marks if set true.
	 * 
