/**
 ...
 Please note they only work in the default JAVA2D mode and have
 not been tested on all platforms. So if these dialogs don't work
 for you then use those provided by Processing.
...
public void setup() {
  size(660, 420);
  surface.setTitle("Dialogs (Message, Option, File & Color chooser)");
