//*********************************************
//  C_LoadModel_LReg_Accelometer_3Axes : Load a Linear Regression model
//
...
//
//  You can generate your own model by using the TrainModel_LReg_Accelerometer example  
//
//  The program will read a LReg trained model and the .arff
...
void setup() {
  ...
  wp.loadModel("LinearReg.model");                                        // Save the model
