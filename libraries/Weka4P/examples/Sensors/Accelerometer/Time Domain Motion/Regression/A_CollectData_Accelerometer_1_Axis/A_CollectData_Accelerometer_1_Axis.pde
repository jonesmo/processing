//*********************************************
//  A_CollectData_Accelerometer_1_Axis : Collects data from a accelerometer with Arduino with numerical labels
//
...
String dataSetName = "A0GestTrainNum"; 
...
void draw() {
  ...
  showInfo("Current Label: "+labelIndex, 20, 20);
