//*********************************************
//  A_CollectData : Collects face data from camera
//
...
//  Manual:
//
//  Start the program and show your face. 
//  You can show different faces or try to experiment with facial expressions.
//
