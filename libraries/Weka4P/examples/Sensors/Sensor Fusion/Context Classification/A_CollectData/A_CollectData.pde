//*********************************************
//  A_CollectData : Collects data from multiple sensor samples
//
...
//
//  Manual:
//  Upload the Arduino sketch (Serial_Rx_Tx_MPU6050_Analog) to your Arduino 
//  (or other board like Teensy), make sure the device is connected.
//
//  You can find this sketch in the Arduino folder of the Context Classification examples.
//
