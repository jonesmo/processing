//*********************************************
//  A_CollectData_mouse : Collects data from user input with the mouse
//
...
String dataSetName = "mouseTrain";                              // Name fo the dataset file
//String dataSetName = "mouseTest";                               // Name fo the test dataset file
String[] attrNames = new String[]{"x", "y", "label"};           // Names of the headers
boolean[] attrIsNominal = new boolean[]{false, false, true};    // Boolean array to address if the values are Nominal or not
