//*********************************************
//  D_CSearch_LSVC_Mouse : Tool for testing different C values
//
...
double[] CArray = {1, 2, 4, 8, 16, 32, 64, 128, 256};  // Array of C values to search
...
void draw() {
  ...
  if (!showModelOnly)
    wp.drawCSearchResults(0, 0, width, height);        // Draw the statistics
}
