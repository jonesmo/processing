//*********************************************
//  B_TrainModel_LSVR_Mouse : Trains a Linear Support Vector Regressor from mouse data
//
...
//
//  The program will train a LSVR with the data provided
...
void setup() {
  ...
  wp.saveModel("LSVR.model");                          // Save the model to the data folder
}
