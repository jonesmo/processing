//*********************************************
//  B_TrainModel_KSVR_Mouse : Trains a Kernel Support Vector Regressor from mouse data
//
...
void setup() {
  ...
  wp.trainRBFSVR(0.001, 1);                            // Train a KSVR classifier (epsilon=0.001, gamma=1)
  ...
  wp.saveModel("KSVR.model");                          // Save the model to the data folder
}
